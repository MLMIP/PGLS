...
MODEL_DIR=None
# node 3
# MODEL_DIR='/media/s5/wyj/Datas_with_code/CUB3/checkpoint/cub200/base/ft_cos-avg_cos-data_init-start_0/Epo_100-Lr_0.0100-Step_25-Gam_0.25-Bs_256-Mom_0.90-T_16.00/session0_max_acc.pth'
# DATA_DIR = '/storage/node3/wyj/pytorch/pytorch/Datas_with_code/fast/data/'

#node 5
# MODEL_DIR = '/media/s5/wyj/Datas_with_code/CUB200/checkpoint/miniImageNet/session0_max_acc.pth'
dataset = 'cub200'
GPU = '1'
# DATA_DIR = '/media/s5/wyj/Datas_with_code/CUB200/data'
# node 7

# Milestone_list = [40,70,100]
Milestone_list = [20,60,80]
DATA_DIR = '/storage/student1/cxb/wyj/CUB200/data'
# MODEL_DIR = '/storage/student1/cxb/wyj/CUB3/checkpoint/cub200/base/ft_cos-avg_cos-data_init-start_0/(60.424)Epo_200-Lr_0.0100-Step_25-Gam_0.25-Bs_256-Mom_0.90-T_16.00/session0_max_acc.pth'
PROJECT='base'
Seed = 1
epochs_base = 100
...
def get_command_line_parser():
    ...
    parser.add_argument('-milestones', nargs='+', type=int, default=Milestone_list)
    ...
    parser.add_argument('-std',default = 0.01 , help = 'noise')
